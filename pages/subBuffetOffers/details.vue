<template>
	<view class="self-help-detail themef7">
		...
		<!-- 内容区域 -->
		<scroll-view scroll-y="true" class="self-help-list-flex">
			<component :is="componentName" :typeTab="tabType"></component>
		</scroll-view>
		<!-- 弹窗 -->
		<subPopup ref="popup" type="center" :backgroundColor="showMore ? '#ffffff' : '#f8f8f8'">
			...
			<view class="more-container" v-else>
				...
				<view class="more-list-ul">
					<view class="more-list-li" v-for="(items,i) in tabList" :key="i"
